    ...
    <footer className='footer'>
      ...
      <div className='footer-segundo-bloque'>
        ...
        <div className='footer-redes-sociales'>
          <h3>
            <NavLink><img src="src/assets/images/instagram.svg" alt="instagram-logo" /></NavLink>
            <NavLink><img src="src/assets/images/facebook.svg" alt="facebook-logo" /></NavLink>
            <NavLink><img src="src/assets/images/twitterx.svg" alt="twitter-logo" /></NavLink>
          </h3>
